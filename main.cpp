...
const int pinoKeypad = A2;
  // Pino analógico para o keypad
// ============================================
...
#define PULSOS_POR_VOLTA_DIR 45   // Pulsos por volta - Roda DIREITA
...
int PULSOS_90GRAUS_DIR;
  // Pulsos para 90° - roda direita
  int PULSOS_90GRAUS_ESQ;
  // Pulsos para 90° - roda esquerda
...
char filaComandos[20] = "";
  // Array fixo de caracteres
...
void pararMotores() {
  ...
  piscarLedsFeedback() {
   ...
   digitalWrite(pinoLedDireito, HIGH);
    // Liga o LED direito
 delay(100);
                // Espera por 100 milissegundos (duração da piscada)
 digitalWrite(pinoLedEsquerdo, LOW);
    // Desliga o LED esquerdo
 digitalWrite(pinoLedDireito, LOW);
    // Desliga o LED direito
}
// =================================================================
